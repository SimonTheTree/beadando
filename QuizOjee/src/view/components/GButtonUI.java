...
public class GButtonUI extends BasicButtonUI implements MouseListener {
	...
	public GButtonUI(Color normalColor, Color hoverColor, Color pressedColor) {
		this(normalColor, hoverColor, pressedColor, null, Color.BLACK);
	}

	public GButtonUI(Color normalColor, Color hoverColor, Color pressedColor, Font btnFont, Color btnFontColor) {
	...
	public GButtonUI(ImageIcon normalIcon, ImageIcon hoverIcon, ImageIcon pressedIcon) {
		this(normalIcon, hoverIcon, pressedIcon, null, Color.BLACK);
	}

	public GButtonUI(ImageIcon normalIcon, ImageIcon hoverIcon, ImageIcon pressedIcon, Font btnFont,
			Color btnFontColor) {
